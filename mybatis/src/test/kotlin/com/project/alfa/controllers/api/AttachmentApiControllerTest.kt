...
internal class AttachmentApiControllerTest {
    ...
    fun setup() {
        ...
        val resource = mock(UrlResource::class.java)
    ...
    fun findAllFilesByPost() {
        ...
        //When
        val actions = mockMvc.perform(get("/api/posts/{postId}/attachments", postId)
    ...
    fun downloadFile() {
        ...
        //When
        val actions = mockMvc.perform(get("/api/posts/{postId}/attachments/{fileId}/download", postId, fileId)
        ...
        actions.andExpect(status().isOk)
                ...
                .andExpect(header().longValue(HttpHeaders.CONTENT_LENGTH, attachments[0].fileSize))
                .andDo(print())
        
        verify(attachmentService, times(1)).findFileById(any<Long>())
        verify(fileUtil, times(1)).readAttachmentFileAsResource(any<AttachmentResponseDto>())
    }
