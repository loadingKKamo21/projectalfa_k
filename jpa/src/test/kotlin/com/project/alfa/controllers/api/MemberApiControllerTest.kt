...
internal class MemberApiControllerTest {
    ...
    fun joinPage() {
        ...
        //When
        val actions = mockMvc.perform(MockMvcRequestBuilders.get("/api/members")
                                              .accept(MediaType.APPLICATION_JSON_VALUE)
                                              .contentType(MediaType.APPLICATION_JSON_VALUE))
        
        //Then
        actions.andExpect(MockMvcResultMatchers.status().isOk)
                .andExpect(MockMvcResultMatchers.content().json(gson.toJson(MemberJoinRequestDto())))
    ...
    fun join() {
        ...
        //When
        val actions = mockMvc.perform(MockMvcRequestBuilders.post("/api/members")
                                              .accept(MediaType.APPLICATION_JSON_VALUE)
                                              .contentType(MediaType.APPLICATION_JSON_VALUE)
                                              .content(gson.toJson(
        ...
        //Then
        actions.andExpect(MockMvcResultMatchers.status().isOk)
                .andExpect(MockMvcResultMatchers.content().string("Member joined successfully."))
                .andDo(MockMvcResultHandlers.print())
    ...
    fun forgotPassword() {
        ...
        //When
        val actions = mockMvc.perform(MockMvcRequestBuilders.post("/api/members/forgot-password")
                                              .accept(MediaType.APPLICATION_JSON_VALUE)
                                              .contentType(MediaType.APPLICATION_JSON_VALUE)
        ...
        //Then
        actions.andExpect(MockMvcResultMatchers.status().isOk)
                .andExpect(MockMvcResultMatchers.content().string("Successfully sending of \"Find Password\" email."))
                .andDo(MockMvcResultHandlers.print())
    ...
    fun profilePage() {
        ...
        //When
        val actions = mockMvc.perform(MockMvcRequestBuilders.get("/api/members/profile")
                                              .accept(MediaType.APPLICATION_JSON_VALUE)
                                              .contentType(MediaType.APPLICATION_JSON_VALUE))
        
        //Then
        actions.andExpect(MockMvcResultMatchers.status().isOk)
                .andExpect(MockMvcResultMatchers.content().json(gson.toJson(responseDto)))
                .andDo(MockMvcResultHandlers.print())
    ...
    fun profileUpdatePage() {
        ...
        val actions = mockMvc.perform(MockMvcRequestBuilders.get("/api/members/profile-update")
                                              .accept(MediaType.APPLICATION_JSON_VALUE)
                                              .contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    fun profileUpdate() {
        ...
        //When
        val actions = mockMvc.perform(MockMvcRequestBuilders.post("/api/members/profile-update")
                                              .accept(MediaType.APPLICATION_JSON_VALUE)
                                              .contentType(MediaType.APPLICATION_JSON_VALUE)
        ...
        //Then
        actions.andExpect(MockMvcResultMatchers.status().isOk)
                .andExpect(MockMvcResultMatchers.content().string("Member updated successfully."))
                .andDo(MockMvcResultHandlers.print())
    ...
    fun profileUpdate_invalidId() {
        ...
        actions.andExpect(MockMvcResultMatchers.status().isUnauthorized)
                .andExpect(MockMvcResultMatchers.content().string("Member update denied."))
                .andDo(MockMvcResultHandlers.print())
    ...
    fun deleteAccount() {
        ...
        //When
        val actions = mockMvc.perform(MockMvcRequestBuilders.post("/api/members/delete")
                                              .accept(MediaType.APPLICATION_JSON_VALUE)
                                              .contentType(MediaType.APPLICATION_JSON_VALUE)
                                              .content(gson.toJson(MemberUpdateRequestDto(id = 1L,
                                                                                          password = "Password1!@"))))
    ...
    fun deleteAccount_invalidId() {
        ...
        //Then
        actions.andExpect(MockMvcResultMatchers.status().isUnauthorized)
                .andExpect(MockMvcResultMatchers.content().string("Member delete denied."))
                .andDo(MockMvcResultHandlers.print())
